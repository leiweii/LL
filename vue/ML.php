...
<body>
    ...
    <main>
        <section>
            ...
            <p><strong>Raison sociale :</strong> SS</p>
            <p><strong>Adresse :</strong>89 Av. Jean Jaures,93300 Aubervilliers</p>
            <p><strong>Téléphone :</strong> 07 49 75 62 99</p>
            <p><strong>Email :</strong> shileiwei200@gmail.com</p>
            <p><strong>Directeur de la publication :</strong> LeiWei SHI</p>
        </section>
        ...
        <section>
            <h2>Remarque</h2>
            <p>Les présentes mentions générales sont une reproduction du Modèle Mentions légales fournies par WebExpress dont le titulaire des droits d'auteurs est WebExpress.</p>
        </section>
    </main>
